...
{ path : 'createcollegedata', loadChildren: () => import('./createcollegedata/createcollegedata.module').then(m => m.CreatecollegedataModule), canActivate: [AuthGuard] } , 
{ path : 'getalldeatils', loadChildren: () => import('./getalldeatils/getalldeatils.module').then(m => m.GetalldeatilsModule), canActivate: [AuthGuard] } , 
